"""
Django settings for windBot project.
...
SECRET_KEY = 'django-insecure-#bzrkc+sfh3-e^++v1-0usmb8fwk)s94)@@apny8m8et^loa^s'
...
WSGI_APPLICATION = 'windBot.wsgi.application'
